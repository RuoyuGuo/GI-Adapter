...
class SiglipVisionTransformer(nn.Module):
    ...
    def get_all_features(
        ...
        for i, encoder_layer in enumerate(self.encoder.layers):
            ...
            if get_delta:
                vlm_features[i] = dinov2_siglip[:, dinov2_x.shape[1]:, :].contiguous()
                vfm_features[i] = dinov2_siglip[:, :dinov2_x.shape[1], :].contiguous()[:,1:]
            else:
        ...
        return vlm_features, vfm_features, None, None
